...
class TestHomeView:
    ...
    def test_home_view_unauthenticated(self, client) -> None:
    ...
    def test_home_view_authenticated(self, client, django_user_model) -> None:
    ...
    def test_htmx_behavior(self, client) -> None:
    ...
    def test_htmx_authenticated_redirect(self, client, django_user_model) -> None:
    ...
    def test_cache_control_headers(self, client) -> None:
