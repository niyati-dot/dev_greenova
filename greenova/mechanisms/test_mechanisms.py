...
from mechanisms.figures import (
...
class TestMechanismChartView:
    ...
    @staticmethod
    def test_view_requires_login(client, settings) -> None:
    ...
    @staticmethod
    def test_view_with_authenticated_user_no_project(client, admin_user) -> None:
    ...
    @staticmethod
    def test_view_with_invalid_project_id(client, admin_user) -> None:
    ...
    @staticmethod
    def test_view_with_valid_project(client, admin_user) -> None:
    ...
    @staticmethod
    def test_view_with_invalid_project_id_type(client, admin_user) -> None:
    ...
    @staticmethod
    def test_view_with_negative_project_id(client, admin_user) -> None:
    ...
    @staticmethod
    def test_view_with_htmx_request(client, admin_user) -> None:
...
class TestFigureGeneration:
    ...
    @staticmethod
    def test_get_mechanism_chart(admin_user) -> None:
    ...
    @staticmethod
    def test_get_overall_chart(admin_user) -> None:
    ...
    @staticmethod
    def test_nonexistent_mechanism_chart() -> None:
    ...
    @staticmethod
    def test_generate_pie_chart_with_data() -> None:
    ...
    @staticmethod
    def test_generate_pie_chart_no_data() -> None:
    ...
    @staticmethod
    def test_encode_figure_to_base64() -> None:
    ...
    @staticmethod
    def test_get_overall_chart_with_empty_project(admin_user) -> None:
