...
class TestResponsibilityModel:
    ...
    def test_responsibility_creation(self, responsibility) -> None:
    ...
    def test_responsibility_str(self, responsibility) -> None:
...
class TestResponsibilityModel:
    ...
    def test_role_creation(self, responsibility_role, company) -> None:
    ...
    def test_role_str(self, responsibility_role, company) -> None:
        """Test the string representation."""
        assert str(responsibility_role) == f"Test Role ({company.name})"

    def test_unique_constraint(self, responsibility_role, company) -> None:
...
class TestResponsibilityViews:
    ...
    def test_responsibility_home_view_authenticated(self, client, user) -> None:
    ...
    def test_responsibility_home_view_unauthenticated(self, client) -> None:
        """Test the home view when not logged in."""
        response = client.get(reverse("responsibility:home"))
        assert response.status_code == 302  # Redirect to login

    def test_assignment_list_view(self, client, user) -> None:
    ...
    def test_role_list_view(self, client, user, responsibility_role, company) -> None:
...
class TestResponsibilityTemplateTags:
    ...
    def test_user_has_responsibility(self, user, obligation) -> None:
    ...
    def test_user_responsibility_roles(self, user, obligation) -> None:
        """Test the user_responsibility_roles tag."""
        # Modify to test without the ResponsibilityAssignment model
        roles = user_responsibility_roles(user, obligation)
        assert isinstance(roles, list)

    def test_format_responsibility_roles(self, responsibility_role) -> None:
    ...
    def test_format_responsibility_roles_empty(self) -> None:
        """Test formatting empty role list."""
        html = format_responsibility_roles([])
        assert html == ""

    def test_get_responsible_users(self, obligation) -> None:
...
class TestResponsibilityFigures:
    ...
    def test_get_responsibility_chart(
            self, obligation, environmental_mechanism) -> None:
    ...
    def test_get_responsibility_chart_no_data(self, environmental_mechanism) -> None:
        """Test generating a chart with no data."""
        # No obligations linked to this mechanism
        fig = get_responsibility_chart(environmental_mechanism.id)
        assert isinstance(fig, Figure)

    def test_get_responsibility_chart_with_filtering(
            self, obligation, environmental_mechanism) -> None:
