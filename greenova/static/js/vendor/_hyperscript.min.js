(function (e, t) {
      ...
      while (o < a.length) {
        if (
          ...
          if (n.isWhitespace(q())) {
            ...
            r.push(y());
          } else if (f() && (n.isAlpha(q()) || q() === '\\')) {
            r.push(x());
          } else if (!f() && (n.isAlpha(q()) || n.isIdentifierChar(q()))) {
            r.push(g());
  ...
  class o {
    ...
    makeEvent(t, r) {
      ...
      if (e.Event && typeof e.Event === 'function') {
        n = new Event(t, { bubbles: true, cancelable: true, composed: true });
        n['detail'] = r;
      } else {
  ...
  function T(t) {
    ...
    t.addLeafExpression('objectLiteral', function (e, t, r) {
      ...
      if (!r.matchOpToken('}')) {
        do {
          ...
          i.push(o);
          n.push(a);
        } while (r.matchOpToken(',') && !r.peekToken('}', 0, 'R_BRACE'));
        r.requireOpToken('}');
      }
      return {
        type: 'objectLiteral',
    ...
    t.addGrammarElement('postfixExpression', function (e, t, r) {
      var n = e.parseElement('negativeNumber', r);
    ...
    t.addGrammarElement('negativeNumber', function (e, t, r) {
      if (r.matchOpToken('-')) {
        var n = e.requireElement('negativeNumber', r);
        return {
          type: 'negativeNumber',
          root: n,
          args: [n],
        ...
        return e.requireElement('primaryExpression', r);
      }
    });
    ...
    var s = function (e, t, r, n) {
      ...
      for (var a = 0; a < i.length; a++) {
        var o = i[a];
        if (
          o.compareDocumentPosition(e) === Node.DOCUMENT_POSITION_PRECEDING
        ) {
          return o;
        }
      }
    ...
    var u = function (e, t, r, n) {
      ...
      for (var a = i.length - 1; a >= 0; a--) {
        var o = i[a];
        if (
          o.compareDocumentPosition(e) === Node.DOCUMENT_POSITION_FOLLOWING
        ) {
          return o;
        }
      }
      ...
      if (a == null) {
        if (r.matchToken('is') || r.matchToken('am')) {
          if (r.matchToken('not')) {
            if (r.matchToken('in')) {
              a = 'not in';
            } else if (r.matchToken('a') || r.matchToken('an')) {
              a = 'not a';
              s = true;
    ...
    t.addGrammarElement('logicalOperator', function (e, t, r) {
      ...
      while (i) {
        ...
        n = {
          ...
          evaluate: function (e) {
            return t.unifiedEval(this, e, s === 'or');
          },
        };
        i = r.matchToken('and') || r.matchToken('or');
      }
    ...
    t.addCommand('pick', (e, t, r) => {
      ...
      if (r.matchToken('match')) {
        ...
        let i = '';
        if (r.matchOpToken('|')) {
          i = r.requireTokenType('IDENTIFIER').value;
        }
        r.requireToken('from');
      ...
      if (r.matchToken('matches')) {
        ...
        let i = 'gu';
        if (r.matchOpToken('|')) {
          i = 'g' + r.requireTokenType('IDENTIFIER').value.replace('g', '');
        }
        r.requireToken('from');
        const a = e.parseElement('expression', r);
        return {
