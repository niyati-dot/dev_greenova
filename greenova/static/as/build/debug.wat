(module
 ...
 (type $8 (func (param i32 f32 f32 f32) (result f32)))
 (global $greenova/static/as/assembly/index/THEME_OFFSET i32 (i32.const 0))
 (global $greenova/static/as/assembly/index/ERROR_BUFFER_OFFSET i32 (i32.const 8))
 (global $greenova/static/as/assembly/index/ANIMATION_DATA_OFFSET i32 (i32.const 72))
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 38920))
 (global $~lib/memory/__heap_base i32 (i32.const 38920))
 (memory $0 1)
 ...
 (func $greenova/static/as/assembly/index/recordError (param $code i32) (param $details i32)
  global.get $greenova/static/as/assembly/index/ERROR_BUFFER_OFFSET
  local.get $code
  i32.store8
  global.get $greenova/static/as/assembly/index/ERROR_BUFFER_OFFSET
  i32.const 1
 ...
 (func $greenova/static/as/assembly/index/setTheme (param $theme i32)
  local.get $theme
  i32.const 255
  i32.and
  i32.const 2
  i32.gt_u
  if
   global.get $greenova/static/as/assembly/index/ERROR_THEME
   i32.const 0
   call $greenova/static/as/assembly/index/recordError
   return
  end
  global.get $greenova/static/as/assembly/index/THEME_OFFSET
  local.get $theme
  i32.store8
 )
 ...
 (func $greenova/static/as/assembly/index/resolveTheme (param $systemPrefersDark i32) (result i32)
  (local $theme i32)
  call $greenova/static/as/assembly/index/getTheme
  local.set $theme
  local.get $theme
  global.get $greenova/static/as/assembly/index/THEME_AUTO
  i32.eq
  if
   local.get $systemPrefersDark
   if (result i32)
    global.get $greenova/static/as/assembly/index/THEME_DARK
   else
    global.get $greenova/static/as/assembly/index/THEME_LIGHT
   end
   return
  end
  local.get $theme
 ...
 (func $greenova/static/as/assembly/index/clearError
  global.get $greenova/static/as/assembly/index/ERROR_BUFFER_OFFSET
  global.get $greenova/static/as/assembly/index/ERROR_NONE
  i32.store8
  global.get $greenova/static/as/assembly/index/ERROR_BUFFER_OFFSET
  i32.const 1
  i32.add
 ...
 (func $greenova/static/as/assembly/index/linearEasing (param $current f32) (param $duration f32) (result f32)
  local.get $current
  local.get $duration
  f32.ge
  if
 ...
 (func $greenova/static/as/assembly/index/easeInOutEasing (param $current f32) (param $duration f32) (result f32)
  (local $progress f32)
  local.get $current
  local.get $duration
  f32.ge
 ...
 (func $greenova/static/as/assembly/index/calculateAnimationHeight (param $isExpanding i32) (param $progress f32) (param $startHeight f32) (param $endHeight f32) (result f32)
  (local $heightDiff f32)
  (local $currentDiff f32)
  local.get $progress
  f32.const 1
  f32.ge
  if
  ...
  f32.le
  if
   local.get $startHeight
   return
  end
  local.get $endHeight
  local.get $startHeight
  f32.sub
  local.set $heightDiff
  local.get $heightDiff
  local.get $progress
  f32.mul
  local.set $currentDiff
  local.get $startHeight
  local.get $currentDiff
  f32.add
  return
 )
 (func $greenova/static/as/assembly/index/add (param $a i32) (param $b i32) (result i32)
  local.get $a
  local.get $b
  i32.add
  return
 )
 (func $greenova/static/as/assembly/index/subtract (param $a i32) (param $b i32) (result i32)
  local.get $a
  local.get $b
  i32.sub
  return
