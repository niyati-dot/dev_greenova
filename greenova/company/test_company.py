...
class TestCompanyModels:
    ...
    def test_company_creation(self, test_company) -> None:
    ...
    def test_company_str_representation(self, test_company) -> None:
        """Test the company string representation."""
        assert str(test_company) == "Test Company"

    def test_company_methods(self, company_with_members) -> None:
        ...
        assert CompanyMembership.objects.filter(
            company=company_with_members, user=new_user).exists()
    ...
    def test_membership_primary_constraint(self, test_users) -> None:
    ...
    def test_company_document_creation(
            self,
            test_company,
            test_users,
            test_document) -> None:
...
class TestCompanyViews:
    ...
    def test_company_list_requires_login(self, client) -> None:
    ...
    def test_company_list_view(self, authenticated_client, test_company) -> None:
    ...
    @pytest.mark.parametrize("authenticated_client", ["regular_user"], indirect=True)
    def test_company_detail_view(self, authenticated_client, test_company) -> None:
    ...
    def test_company_search_functionality(self, client, test_users) -> None:
...
class TestCompanyCreation:
    ...
    def test_company_create_requires_login(self, client) -> None:
    ...
    def test_company_create_view_superuser(self, authenticated_client) -> None:
    ...
    def test_company_create_by_company_admin(
            self, authenticated_client, company_with_members) -> None:
...
class TestCompanyEditing:
    ...
    def test_company_edit_by_owner(
            self,
            authenticated_client,
            company_with_members) -> None:
    ...
    def test_company_edit_by_regular_member(
        ...
        assert response.status_code == 302
        assert reverse(
            "company:detail", kwargs={
                "company_id": company_with_members.id}) in response["Location"]
...
class TestCompanyDeletion:
    ...
    @pytest.mark.parametrize("authenticated_client", ["company_owner"], indirect=True)
    def test_company_delete_by_owner(
            self,
            authenticated_client,
            company_with_members) -> None:
    ...
    @pytest.mark.parametrize("authenticated_client", ["company_admin"], indirect=True)
    def test_company_delete_by_admin(
            self,
            authenticated_client,
            company_with_members) -> None:
...
class TestCompanyMemberManagement:
    ...
    def test_add_member(
        ...
        membership = CompanyMembership.objects.get(
            company=company_with_members, user=new_user)
    ...
    @pytest.mark.parametrize("authenticated_client", ["company_admin"], indirect=True)
    def test_remove_member(self, authenticated_client, company_with_members) -> None:
...
class TestCompanyDocumentManagement:
    ...
    def test_upload_document(
        ...
        url = reverse(
            "company:upload_document", kwargs={
                "company_id": company_with_members.id})
...
class TestCompanyPermissions:
    ...
    def test_is_company_admin_function(self, test_users, company_with_members) -> None:
