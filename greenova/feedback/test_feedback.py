...
class TestBugReportModel:
    ...
    def test_create_bug_report(self, regular_user) -> None:
    ...
    def test_bug_report_str(self, regular_user) -> None:
...
class TestFeedbackViews:
    ...
    def test_index_view(self, client, admin_user) -> None:
        """Test the index view."""
    ...
    def test_submit_bug_report(self, client, admin_user) -> None:
    ...
    def test_submit_invalid_bug_report(self, client, admin_user) -> None:
