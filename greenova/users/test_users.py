...
from users.templatetags.user_tags import (
    auth_status_badge,
    auth_user_display,
...
class TestProfileModel:
    ...
    def test_profile_image_upload(self, profile, mock_image) -> None:
...
class TestUserProfileForm:
    ...
    def test_valid_form(self, profile, profile_form_data) -> None:
    ...
    def test_init_populates_user_fields(self, profile) -> None:
    ...
    def test_invalid_email(self, profile) -> None:
...
class TestAdminUserForm:
    ...
    def test_create_user(self, admin_user_form_data) -> None:
    ...
    def test_edit_user(self, user) -> None:
    ...
    def test_optional_password(self, user) -> None:
...
class TestProfileImageForm:
    ...
    def test_valid_image(self, profile, mock_image) -> None:
    ...
    def test_invalid_image(self, profile) -> None:
...
class TestProfileViews:
    ...
    def test_profile_view(self, client, user) -> None:
    ...
    def test_profile_view_htmx(self, client, user) -> None:
        ...
        assert response.status_code == 200
        assert "users/partials/profile_detail.html" in [
            t.name for t in response.templates]

    def test_profile_edit_get(self, client, user) -> None:
    ...
    def test_profile_edit_post(self, client, user, profile_form_data) -> None:
    ...
    def test_change_password_get(self, client, user) -> None:
    ...
    def test_change_password_post(self, client, user) -> None:
    ...
    def test_upload_profile_image(self, client, user, mock_image) -> None:
        """Test uploading a profile image."""
        client.force_login(user)
    ...
    def test_upload_profile_image_htmx(self, client, user, mock_image) -> None:
...
class TestAdminViews:
    ...
    def test_admin_user_list(self, client, admin_user, user) -> None:
    ...
    def test_admin_user_list_access_denied(self, client, user) -> None:
        """Test that regular users can't access admin views."""
        client.force_login(user)
        response = client.get(reverse("users:admin_user_list"))
        assert response.status_code == 302  # Redirect to login page

    def test_admin_user_create_get(self, client, admin_user) -> None:
    ...
    def test_admin_user_create_post(
            self,
            client,
            admin_user,
            admin_user_form_data) -> None:
    ...
    def test_admin_user_edit_get(self, client, admin_user, user) -> None:
    ...
    def test_admin_user_edit_post(self, client, admin_user, user) -> None:
    ...
    def test_admin_user_delete_get(self, client, admin_user, user) -> None:
    ...
    def test_admin_user_delete_post(self, client, admin_user, user) -> None:
...
class TestUserTemplateTags:
    ...
    def test_full_name_or_username_full_name(self, user) -> None:
    ...
    def test_full_name_or_username_username(self, user) -> None:
    ...
    def test_profile_image_url_with_image(self, user, mock_image) -> None:
    ...
    def test_auth_status_badge_admin(self, admin_user) -> None:
    ...
    def test_auth_status_badge_staff(self, staff_user) -> None:
    ...
    def test_has_verified_email_true(self, mock_email_address, user) -> None:
    ...
    @patch("users.templatetags.user_tags.EmailAddress")
    def test_has_verified_email_false(self, mock_email_address, user) -> None:
    ...
    def test_has_verified_email_anonymous(self) -> None:
